...
En el extracto de código \ref{precompute_mapping_tables} se muestra la implementación del precomputo de las tables de mapeo usando el algoritmo descrito en el apartado anterior.

\PythonCode[precompute_mapping_tables]{File picking}{Precomputación de tablas para un mapeo mas eficiente de las vistas de CubeMap}{EquirectProcessor.py}{29}{71}{}
